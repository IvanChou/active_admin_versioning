  ...
  module ActiveAdmin
    module ResourceController
      ...
      def show
        ...
        @versions = resource.versions.reorder(id: :desc, created_at: :desc).page(version).per(1)
        @version_number = version > 0 ? @versions.total_count - (version - 1) : @versions.total_count
